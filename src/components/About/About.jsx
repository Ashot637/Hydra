...
import img from '../../img/boyVR.jpg';
import DataContext from '../../context/context';
import Aos from 'aos';
import 'aos/dist/aos.css';

const About = () => {
    const { aboutRef } = useContext(DataContext);
    ...
    return (
        <div className={classes.about} ref={aboutRef}>
            <div className="container">
                <svg width="1440" height="219" viewBox="0 0 1440 219" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes.line1}>
                ...
                <svg width="1440" height="262" viewBox="0 0 1440 262" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes.line2}>
                ...
                <div className={classes.inner}>
                    <img src={img} alt="boy with VR" className={classes.img} data-aos="fade-right" data-aos-duration="2000" />
                    <div className={classes.text}>
                        <h2 className={classes.title}>ABOUT</h2>
                        <span className={classes.subtitle}>HYDRA VR</span>
                        <span className={classes.desc}>Eget mi proin sed libero enim sed faucibus turpis. Nisl rhoncus mattis rhoncus
